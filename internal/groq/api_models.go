...
func (r ApiListModelsRequest) Execute() (*ModelList, *http.Response, error) {
...
//  @return ModelList
func (a *ModelsAPIService) ListModelsExecute(r ApiListModelsRequest) (*ModelList, *http.Response, error) {
	var (
